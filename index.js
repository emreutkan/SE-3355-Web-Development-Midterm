...
const fetchQuickLinks = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const res = yield fetch(QUICK_LINKS_API);
...
const fetchMainSlider = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const res = yield fetch(SLIDER_API);
        const data = yield res.json();
...
const fetchElectronicsDeals = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const res = yield fetch(ELECTRONICS_API);
        const data = yield res.json();
...
const fetchRecommended = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const res = yield fetch(RECOMMENDED_API);
        const data = yield res.json();
